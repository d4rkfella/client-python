...
```sh
pip install git+https://github.com/d4rkfella/client-python.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/d4rkfella/client-python.git`)
...
api_instance = kubevirt.DefaultApi(kubevirt.ApiClient(configuration))
